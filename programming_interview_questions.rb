...
# end
#
# p array_pair_sum([2, 3, 5, 6, 1, 4], 5)
...
p array_pair_sum([2, 3, 5, 6, 1, 4], 5)
p array_pair_sum([1, 2, -1], 0)          # => #<Set: {[-1, 1]}>
p array_pair_sum([1, 2, -1, -1], 0)      # => #<Set: {[-1, 1]}>
p array_pair_sum([1, 2, -1, -1, -2], 0)  # => #<Set: {[-1, 1], [-2, 2]}>
p array_pair_sum([1, 2, -1, -1, -2], 1)  # => #<Set: {[-1, 2]}>
p array_pair_sum([1, 2, -1, -1, -2], -1) # => #<Set: {[-2, 1]}>
